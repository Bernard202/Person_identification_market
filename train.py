...
def softmax_pretrain_on_dataset(source, project_path='/home/mahmoud/Desktop/LIP_JPPNet-master/rank-reid-2', dataset_parent='/home/mahmoud/Market-1501-v15.09.15'):
    if source == 'market':
        train_list = project_path + '/dataset/market_no_bk.list'
        train_dir = dataset_parent + '/new_market_no_back'
        class_count = 751
    elif source == 'grid':
        ...
        train_dir = 'unknown'
        class_count = -1
    softmax_model_pretrain(train_list, train_dir, class_count, source + 'one_side_new_market_bk.h5')
